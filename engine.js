var Engine =
{
	...
	Resources :
	{
		// General vertex shader permutations
		...
		vs_general_transformed_uv_normals_tangents_shadow             : { file: "enginejs/resources/shaders/general.vs", define : [ "ENGINEJS_ENABLE_TRANSFORM", "ENGINEJS_ENABLE_UV_COORDS", "ENGINEJS_ENABLE_NORMALS", "ENGINEJS_ENABLE_TANGENTS", "USE_SHADOWS" ] },
		...
		fs_mat_standard_amb_shadow                                                  : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_shadow                                              : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_shadow                                         : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SHADOWS"] },
		fs_mat_standard_amb_lit_spec_specmap_shadow                                 : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_SHADOWS"] },
		fs_mat_standard_amb_lit_normalmap_shadow                                    : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_NORMAL_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_normalmap_shadow                               : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_NORMAL_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_specmap_normalmap_shadow                       : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_NORMAL_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_fresnel_shadow                                          : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_FRESNEL", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_fresnel_shadow                                      : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_FRESNEL", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_fresnel_shadow                                 : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_FRESNEL", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_specmap_fresnel_shadow                         : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_FRESNEL", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_normalmap_fresnel_shadow                            : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_normalmap_fresnel_shadow                       : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_SHADOWS" ] },
		...
		fs_mat_standard_amb_reflectionmap                                           : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_reflectionmap                                       : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_reflectionmap                                  : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_specmap_reflectionmap                          : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_REFLECTION_MAP"] },
		fs_mat_standard_amb_lit_normalmap_reflectionmap                             : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_NORMAL_MAP", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_normalmap_reflectionmap                        : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_NORMAL_MAP", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_specmap_normalmap_reflectionmap                : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_NORMAL_MAP"," USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_fresnel_reflectionmap                                   : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_FRESNEL", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_fresnel_reflectionmap                               : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_FRESNEL", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_fresnel_reflectionmap                          : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_FRESNEL", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_specmap_fresnel_reflectionmap                  : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_normalmap_fresnel_reflectionmap                     : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_normalmap_fresnel_reflectionmap                : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_lit_spec_specmap_normalmap_fresnel_reflectionmap        : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP" ] },
		fs_mat_standard_amb_reflectionmap_shadow                                    : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_reflectionmap_shadow                                : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_reflectionmap_shadow                           : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_REFLECTION_MAP", "USE_SHADOWS"] },
		fs_mat_standard_amb_lit_spec_specmap_reflectionmap_shadow                   : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_REFLECTION_MAP", "USE_SHADOWS"] },
		fs_mat_standard_amb_lit_normalmap_reflectionmap_shadow                      : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_NORMAL_MAP", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_normalmap_reflectionmap_shadow                 : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_NORMAL_MAP", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_specmap_normalmap_reflectionmap_shadow         : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_NORMAL_MAP", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_fresnel_reflectionmap_shadow                            : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_FRESNEL", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_fresnel_reflectionmap_shadow                        : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_FRESNEL", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_fresnel_reflectionmap_shadow                   : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_FRESNEL", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_specmap_reflectionmap_fresnel_shadow           : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_normalmap_fresnel_reflectionmap_shadow              : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_normalmap_fresnel_reflectionmap_shadow         : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		fs_mat_standard_amb_lit_spec_specmap_normalmap_fresnel_reflectionmap_shadow : { file: "enginejs/resources/shaders/3d/material-standard.fs", define : [ "USE_DIFFUSE", "USE_SPECULAR", "USE_SPECULAR_MAP", "USE_NORMAL_MAP", "USE_FRESNEL", "USE_REFLECTION_MAP", "USE_SHADOWS" ] },
		...
		mat_shadow_mapping_render                                     : { file: "enginejs/resources/materials/shadow-mapping-render.mat" },
