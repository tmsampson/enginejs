// a variant from https://www.shadertoy.com/view/ltj3Dc and https://www.shadertoy.com/view/MlB3Wt
...
#else  // thanks Dave ! :-)
    return texture2D( iChannel0, ((n.xy+vec2(37.0,17.0)*n.z+.5))/256.0, -100.0).xyz;
#endif
}
