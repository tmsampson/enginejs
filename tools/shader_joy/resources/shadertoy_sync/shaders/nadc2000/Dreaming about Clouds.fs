// Based on inigo quilez - iq/2013 shader https://www.shadertoy.com/view/XslGRr
...
vec4 render( in vec3 ro, in vec3 rd, in vec2 coo )
{
    ...
    col = texture2D( iChannel1, coo.xy).rgb;
...
{
    fragColor = render( fragRayOri, fragRayDir, fragCoord );
}