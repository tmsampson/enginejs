...
{	   
	...
	else
    {
        ...
        pixelColor  = GetPixelColor(PixelToWorld(fragCoord.xy + a)) * 0.2;
        pixelColor += GetPixelColor(PixelToWorld(fragCoord.xy + b)) * 0.4;
        pixelColor += GetPixelColor(PixelToWorld(fragCoord.xy + c)) * 0.4;
	}		
